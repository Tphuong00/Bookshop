...
export const addBook = (id_category, name, price, release_date, describe, quantity, id_nsx, id_author, file) =>
...
export const updateBook = (id, name, id_category, price, release_date, describe, quantity, id_nsx, id_author, file) => async (dispatch, getState) => {
    let data = new FormData()
    data.append('file', file)
    data.append('id', id)
    data.append('id_category', id_category) 
